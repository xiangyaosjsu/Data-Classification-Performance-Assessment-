...
<p align="center"> <b> Note </b>: Parameters in <b> Black color </b>: fixed parameter; in <b> Orange color </b>: use grid search to do parameter tuning; in <b> Green color </b>: use ‘sample 1 + smoker_drinker response’ to find the best parameters and apply the selected parameters to all ANN models.![image](https://github.com/xiangyaosjsu/Math-251-Project/assets/145530232/eef2e961-5d17-4f18-9b43-eb4f463875bc)
 </p>
